    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <x-primary-button href="/post/new-post" class="mr-4"> Create Post</x-primary-button>
                ...
                <div class="relative ml-3">
                    ...
                    <div role="menu" tabindex="-1" aria-labelledby="user-menu-button" aria-orientation="vertical"
                        ...
                        {{--Log out--}}
                        <a href="{{route('profile', Auth::user()->username)}}" class="block px-4 py-2 text-sm text-gray-700">Profile</a>
