                ...
                <form action="{{ route('post.update', $post->id) }}"
                    ...
                    @if($post->image)
                        <div class="mb-4">
                            ...
                            <img src="{{ asset('storage/' . $post->image) }}" alt="Current post image" class="mt-2 max-w-xs h-auto rounded">
                        </div>
                    @endif
                    ...
                    <div>
                        ...
                        <x-input-text id="image" class="block mt-1 w-full" type="file" name="image" autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <x-input-text id="title" class="block mt-1 w-full" type="text" name="title"
                    ...
                    <div class="mt-4">
                        ...
                        <x-input-textarea id="content" class="block mt-1 w-full h-32" name="content"
                    ...
                    <div class="mt-4">
                        ...
                        <x-input-text id="published_at" class="block mt-1 w-full" type="datetime-local" name="published_at"
                                      :value="old('published_at', $post->published_at ? $post->published_at->format('Y-m-d\TH:i') : '')" autofocus />
